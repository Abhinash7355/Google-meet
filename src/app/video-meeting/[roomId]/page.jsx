  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      >
        <div
          ref={containerRef}
          className="flex-grow video-container"
      ...
      {!isInMeeting && (
        <div className="flex flex-col">
          <div className="p-6">
            ...
            <Button
              onClick={endMeeting}
              className="w-full text-white bg-red-500 hover:bg-red-200 hover:text-black"
            >
              End Meeting
            </Button>
          </div>
          <div className="grid grid-cols-1 gap-6 p-6 bg-gray-200 md:grid-cols-3 dark:bg-gray-700">
